...
public class CancelPackButton {
    public static void register(ButtonDispatcher<GuildButtonInteraction> dispatcher) {
        dispatcher.register("pcp", interaction -> {
            ...
            try {
                ...
                puzzle.cancelPack(interaction.deferEdit());
    ...
    public static Button create(String label, ButtonStyle style, Perms permission) {
        return Button.of(style, new Gson().toJson(new ButtonData("pcp", permission)), label);
    }
}
