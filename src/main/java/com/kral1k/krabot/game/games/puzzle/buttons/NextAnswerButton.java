...
public class NextAnswerButton {
    public static void register(ButtonDispatcher<GuildButtonInteraction> dispatcher) {
        dispatcher.register("pna", interaction -> {
            ...
            try {
                ...
                puzzle.next(interaction.deferEdit());
    ...
    public static Button create(String label, ButtonStyle style, Perms permission) {
        return Button.of(style, new Gson().toJson(new ButtonData("pna", permission)), label);
    }
}
