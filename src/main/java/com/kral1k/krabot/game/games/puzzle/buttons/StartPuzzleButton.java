...
public class StartPuzzleButton {
    public static void register(ButtonDispatcher<GuildButtonInteraction> dispatcher) {
        dispatcher.register("ps", interaction -> {
            ...
            try {
                ...
                puzzle.startPuzzle(interaction.deferEdit());
    ...
    public static Button create(String label, ButtonStyle style, Perms permission) {
        return Button.of(style, new Gson().toJson(new ButtonData("ps", permission)), label);
    }
}
